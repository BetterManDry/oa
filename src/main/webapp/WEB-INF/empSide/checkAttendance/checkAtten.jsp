...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/js/verificationNumbers.js"
            tppabs="${pageContext.request.contextPath}/static/js/verificationNumbers.js"></script>
    <style>
        .J_codeimg {
            z-index: -1;
            position: absolute;
    ...
    <div class="input-content" style="margin-top: 150px;">
        <div class="login_tit">
            <button class="button button-block bg-main text-big input-big">
                <a href="${pageContext.request.contextPath}/empSide/EmpCheckAtten.a">打卡上班</a></button>
        </div>
