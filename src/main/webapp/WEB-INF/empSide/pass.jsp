  ...
  <script>
    $(function () {
      $("#subBut").click(function () {
        ...
        $.post("${pageContext.request.contextPath}/empSide/upEmpPass.a",data,function (message) {
            alert(message);
          window.location.href="${pageContext.request.contextPath}/empSide/toPass.a"
        },"text")
      })
    })
  </script>
